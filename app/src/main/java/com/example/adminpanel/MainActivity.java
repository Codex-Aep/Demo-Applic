...
import com.example.adminpanel.ModelClasses.AddData;
        ...
        imageRef.putFile(imageUri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    imageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(MainActivity.this, "Failed to get image download URL", Toast.LENGTH_SHORT).show();
                    });
                })
                .addOnFailureListener(e -> {
        ...
        if (uniqueKey != null) {
            reference.child(uniqueKey).setValue(new ImageData(imageUrl, imageName))
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            Toast.makeText(MainActivity.this, "Image URL saved to database", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(e -> {
                        Toast.makeText(MainActivity.this, "Failed to save image URL to database", Toast.LENGTH_SHORT).show();
                    });
        }
    }
        ...
        categoryRef.setValue(category)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(MainActivity.this, "Selected Category Uploaded to Firebase", Toast.LENGTH_SHORT).show();

                    } else {

                        Toast.makeText(MainActivity.this, "Failed to upload selected category", Toast.LENGTH_SHORT).show();
...
//---------------------------------------------------------------------------------//
//    private void AddDatatoRealtimedatabase(String productname, String productsize) {
//        AddData obj = new AddData(productname, productsize);
//        FirebaseDatabase database;
//        DatabaseReference reference;
//        database = FirebaseDatabase.getInstance();
//        reference = database.getReference("Product Name");
//
//    }
//}
//--------------------------------------------------------------------------------//